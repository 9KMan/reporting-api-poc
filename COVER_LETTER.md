...
I've built quite a few reporting systems over 20+ years, and your screening questions caught my attention — they're exactly the kind of problem-solving I enjoy.

Most applicants will tell you how they'd handle primary→secondary fallback. I've actually built it:

→ https://github.com/9KMan/reporting-api-poc

The code in the repo answers both of your screening questions with working implementation, not just text. I believe in showing rather than telling.

I'm looking for 25-30 hours/week at $85-95/hr, available within 48 hours. Based in Bangkok (GMT+7), well within your ±2 window.

Happy to discuss your architecture and deliver these reporting slices end-to-end.
